...
-- );
	...
	-- '1.44',
	-- 2019.11.20,
INSERT INTO films(name, duration, release, restriction, synopsis) values(
...
INSERT INTO films(name, duration, release, restriction, synopsis) values(
	...
	"",
	"Victor, un sexagénaire désabusé, voit sa vie bouleversée le jour où Antoine, un brillant entrepreneur, lui propose une attraction d u nouveau : mélangeant artifices théâtraux et reconstitution historique, cette entreprise propose à ses clients de replonger dans l'époque de leur choix. Victor choisit alors de revivre la semaine la plus marquante de sa vie : celle où, 40 ans plus tôt, il rencontra le grand amour..."
);
