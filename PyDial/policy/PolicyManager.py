    ...
    def _load_domains_policy(self, domainString=None):
        ...
        if domainString in self.SPECIAL_DOMAINS:
            if domainString == 'topicmanager':
                ...
                import HDCTopicManager # from policy
            ...
            if policy_type == 'hdc':
                ...
                import TRACERPolicy # from policy
                ...
                import ConcreteDQNPolicy # from policy
                ...
                import BootstrappedDQNPolicy # from policy
                ...
                import DropoutDQNPolicy # from policy
                ...
                import FeudalPolicy # from policy
                ...
                import FeudalACPolicy # from policy
...
#                 policy = NNPolicy.NNPolicy(use_confreq=useconfreq, is_training=train)           
    ...
    def _load_committees(self):
        ...
        useBCM = False
        learningMethod = "singleagent" # from policy
